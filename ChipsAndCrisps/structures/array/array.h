...
namespace structures 
{
	...
	{
		//TODO 02: Array
		if (this != &other) { //Ëi nepriradujem sam do seba

			if (size_ != other.size_) { 

				throw std::invalid_argument("Arrays sizez different");
			}
			*vector_ = *(other.vector_); //bez hviezdiciek priradujem smernik, s nimi ich hodnoty
	...
	{
		//TODO 02: Array
		//1. oöetriù index--> pouûijem mapovaciu funkciu
		//2. index prvku pola - >prepoËÌtam na index vektora
		//3. getbytePointer, d· mi smernÌk na byte, ktor˝ pretypujemna smernÌk na T(vöeobecne)
		//4. *T

		int vecotrIndex = mapFunction(index);
		byte* vectorPointer = vector_->getBytePointer(vecotrIndex);
	...
	{
		//TODO 02: Array
		//treba porovnaù veækosù a d·ta to vie aj vektor
		//inline znamen·, ûe sa kod nakopiruje  a nesk·Ëe niekam inam do metÛd, ned· sa pouûiù na rekurziu
	...
	{
		//TODO 02: Array
		//poËet bajtov kr·t index poæa (sizeof(T))
